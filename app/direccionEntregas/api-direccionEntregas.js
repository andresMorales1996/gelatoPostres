document.addEventListener("DOMContentLoaded", function() {
    ...
    function getAllDireccionEntregas() {
      fetch("http://localhost:8080/allDireccionEntregas")
        ...
        .then(data => {
          ...
          data.forEach(direccionEntregas => {
            ...
            cellId.textContent = direccionEntregas.id_direccionEntregas;
            row.appendChild(cellId);
  
            const celldireccionEntregas = document.createElement("td");
            celldireccionEntregas.textContent = direccionEntregas.direccionEntregas;
